...
public class PrincipalScript : MonoBehaviour
{
	...
	private void CorrectPlayer()
	{
        ...
        else if (this.playerScript.guiltType == "stunning")
        {
            this.audioQueue.QueueAudio(this.audNoStabbing);
        }
		else if (this.playerScript.guiltType == "bullying")
		{
			this.audioQueue.QueueAudio(this.audNoBullying);
		}
		else if (this.playerScript.guiltType == "sabotage")
		{
			this.audioQueue.QueueAudio(this.audNoSabotage);
		}
	}
	...
	public AudioClip audNoSabotage;
